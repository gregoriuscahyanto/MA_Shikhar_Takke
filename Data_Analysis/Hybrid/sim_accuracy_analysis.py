...
# ── Config ──────────────────────────────────────────────────────────────────
XLSX_FILE  = "Comparison Hybrid Final_Simulation_Results_ALL_RUN_IDs.xlsx"
OUT_DIR    = "output"
SIM_VER    = "2.3"          # change if you update the column name
TOLERANCE  = 0.10           # ±10 %
BINS       = [0, 5, 7, 10, 13, 15]
...
fig2.update_yaxes(title_text="Mean % Error", range=[-70, 90])
fig2.update_layout(
    title={
        "text": (
