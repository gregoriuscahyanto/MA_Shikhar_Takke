...
# Configuration
file_name = "NewActual_Simulation_Comparison.xlsx"
actual_col = "Actual 0 to 100"
error_col = "Faster than actual_6.4"
sim_col = "SL_time_0_to_100_6.4"
...
fig1.tight_layout()
fig1.savefig("cccccccccccccccerror_analysis_percentage_xxxxxxxxxxxx.png", dpi=300, bbox_inches='tight')
...
fig2.tight_layout()
fig2.savefig("cccccccccccactual_vs_simulated_0to100.png", dpi=300, bbox_inches='tight')
